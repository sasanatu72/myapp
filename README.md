...
自分が普段日常生活で使っているさまざまな機能を、一つのアプリに集約させたいという目的で本アプリを開発しました。また、就職活動用のポートフォリオとして、画面実装だけでなく、認証、API設計、DB設計、CRUD処理、マイグレーション、デプロイまで一通り経験することを目的に開発しました。

## 開発上のポイント

このアプリでは、以下を意識して開発しました。

- チームでの開発を意識したフロントエンドとバックエンドを分離した構成
- JWTを用いた認証処理
- ユーザーごとのデータ分離
- SQLAlchemyによるDB操作
